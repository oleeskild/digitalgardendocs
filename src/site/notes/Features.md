---
{"dg-publish":true,"permalink":"/features/","dg-note-properties":{}}
---
...
Publish your canvas files, including images, webpages, other notes and groupings. 

See this canvas for setting this up
[[Digital Garden Canvas Publish Tutorial.canvas\|Digital Garden Canvas Publish Tutorial.canvas]]
...
## Random page
Your garden has a built-in random page URL at `/~random/`. Visiting this URL will redirect you to a random published note in your garden. You can use this to add a "Random note" link in your garden, or just visit it yourself to rediscover old notes.